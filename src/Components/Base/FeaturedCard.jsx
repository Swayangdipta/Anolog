...
const FeaturedCard = () => {
  return (
    ...
    <div className='w-full h-[80%] rounded relative top-0 group'>
        ...
        <div className='w-full h-0 p-2 duration-500 group-hover:h-full bg-[#000000de] absolute bottom-0 left-0 rounded overflow-hidden text-zinc-300 text-[10px] md:text-[16px] leadinvioletp6]'>
        ...
        <div className='absolute bottom-0 left-0 w-full h-[30px] bg-black rounded-b flex items-center justify-between px-[10px]'>
            <span className='text-violet-600 text-[18px] md:text-[22px] flex items-center gap-[5px]'>
                <AiFillHeart />
                <p className='text-[12px]'>22.5k</p>
            </span>

            <span className='text-violet-600 text-[22px] hidden md:flex items-center gap-[5px]'>
                <AiFillMessage />
